...
export const OFFICIAL_EXAM_INFO = {
  ...
  cadre: "क्ष-किरण वैज्ञानिक अधिकारी (क्ष-किरण तंत्रज्ञ) / X-Ray Scientific Officer",
  postType: "गट 'क' पद भरती (Group C Recruitment)",
  totalMarks: 200,
  totalQuestions: 100,
  durationMinutes: 120,
  marksPerQuestion: 2,
...
export const CATEGORIES: CategoryInfo[] = [
  {
    ...
    nameMr: 'तांत्रिक: रेडिओफिजिक्स व क्ष-किरण यंत्राची तत्त्वे',
    section: 'technical',
    description: 'X-Ray machine history, C-Arm, CT Scan, MRI, Mammography principles, tube construction, and x-ray production.',
    descriptionMr: 'क्ष-किरण यंत्राचा इतिहास, सी-आर्म, सी.टी. स्कॅन, एम.आर.आय., मॅमोग्राफीची तत्त्वे व मशीनची माहिती.',
    marks: 16,
    questionCount: 8,
    color: 'teal',
    iconName: 'Activity'
  },
  {
    ...
    nameMr: 'तांत्रिक: शरीरशास्त्र व क्ष-किरण पोझिशनिंग',
    section: 'technical',
    description: 'Anatomy, physiological positioning for X-ray, C-Arm, MRI, CT, Mammography, and special projections.',
    descriptionMr: 'शरीरशास्त्र, अवयवांची रचना व क्ष-किरण, सी-आर्म, एम.आर.आय., सी.टी. स्कॅन साठी विविध पोझिशन.',
    marks: 16,
    questionCount: 8,
    color: 'cyan',
    iconName: 'Layers'
  },
  {
    ...
    nameMr: 'तांत्रिक: रेडिएशन सुरक्षा व धोके',
    section: 'technical',
    description: 'Radiation hazards, ALARA principle, TLD badges, lead aprons, shieldings, AERB norms, and safety.',
    descriptionMr: 'रेडिएशनचे धोके, अलारा (ALARA) तत्त्व, टी.एल.डी. बॅज, शिशाचे ॲप्रॉन, रेडिएशनपासून बचाव व सुरक्षा.',
    marks: 16,
    questionCount: 8,
    color: 'emerald',
  ...
  },
  {
    ...
    nameMr: 'तांत्रिक: फिल्म्स, कॉन्ट्रास्ट डाय व डिजिटल DR/PACS',
    section: 'technical',
    description: 'X-ray films, chemical developer/fixer, contrast dye reactions, emergency care, DR, PACS & BMW management.',
    descriptionMr: 'क्ष-किरण फिल्म्स, डेव्हलपर व फिक्सर रसायने, कॉन्ट्रास्ट डायचे प्रकार, डिजिटल रेडिओोग्राफी, पी.ए.सी.एस. व जैववैद्यकीय कचरा व्यवस्थापन.',
    marks: 16,
    questionCount: 8,
    color: 'amber',
    iconName: 'Syringe'
  },
  {
    ...
    nameMr: 'तांत्रिक: प्रगत तंत्रज्ञान CT/MRI/रेडिओथेरपी',
    section: 'technical',
    description: 'CT Scan, MRI, Radiotherapy, Lithotripsy procedures, complications, and record keeping maintenance.',
    descriptionMr: 'सी.टी. स्कॅन, एम.आर.आय., रेडिओथेरपी, लिथोट्रिप्सी प्रक्रिया, मशीनची देखभाल व नोंदी ठेवणे.',
    marks: 16,
    questionCount: 8,
    color: 'indigo',
    iconName: 'Sparkles'
  },
  {
    ...
    nameMr: 'मराठी भाषा व व्याकरण',
    section: 'marathi',
    description: 'मराठी व्याकरण (वाक्यरचना, शब्दार्थ, प्रयोग, समानार्थी व विरुद्धार्थी शब्द), म्हणी, वाक्प्रचार व प्रसिद्ध पुस्तके-लेखक.',
    descriptionMr: 'मराठी व्याकरण, वाक्यरचना, प्रयोग, समानार्थी-विरुद्धार्थी शब्द, वाक्प्रचार, म्हणी व प्रसिद्ध पुस्तके-लेखक.',
    marks: 30,
    questionCount: 15,
    color: 'orange',
    iconName: 'BookOpen'
  },
  {
    ...
    nameMr: 'इंग्रजी भाषा व व्याकरण',
    section: 'english',
    description: 'English Grammar (Synonyms, Antonyms, Spelling, Punctuation, Tenses), Vocabulary, Idioms, Phrases & Sentence Structure.',
    descriptionMr: 'इंग्रजी व्याकरण, शब्दसंग्रह, समानार्थी व विरुद्धार्थी शब्द, म्हणी व वाक्प्रचार, वाक्यरचना.',
    marks: 30,
    questionCount: 15,
    color: 'blue',
    iconName: 'Languages'
  },
  {
    ...
    nameMr: 'सामान्य ज्ञान व चालू घडामोडी',
    section: 'gk',
    description: 'Maharashtra & India Current Affairs, History, Geography, Constitution, General Science, RTI Act 2005 & IT Knowledge.',
    descriptionMr: 'महाराष्ट्र व भारतातील चालू घडामोडी, इतिहास, भूगोल, भारतीय संविधान, माहितीचा अधिकार २००५ व संगणक ज्ञान.',
    marks: 30,
    questionCount: 15,
    color: 'purple',
    iconName: 'Globe'
  },
  {
    ...
    nameMr: 'बौद्धिक चाचणी व अंकगणित',
    section: 'logical',
    description: 'Aptitude Test, Basic Arithmetic, Mathematics (Algebra, Geometry, Statistics) and Reasoning.',
    descriptionMr: 'बौद्धिक चाचणी, अंकगणित, बीजगणित, भूमिती, सांख्यिकी आणि तर्कक्षमता.',
    marks: 30,
    questionCount: 15,
    color: 'rose',
    iconName: 'Brain'
