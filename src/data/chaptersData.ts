...
export const ALL_30_CHAPTERS: ChapterItem[] = [
  // 1. CORE RADIOLOGY & MACHINE PHYSICS (TOP PRIORITY)
  {
    id: 23,
    part: 'Part V',
    title: 'Chapter 23: X-Ray Tube Design, Anode, and Cathode Physics',
    titleMr: 'प्रकरण २३: क्ष-किरण ट्युब रचना, अ‍ॅनोड, कॅथोड, टंगस्टन फिलामेंट व रोटेटिंग डिस्क',
  ...
  // 2. RADIATION PROTECTION & BIOLOGICAL HAZARDS
  {
    id: 11,
    part: 'Part III',
  ...
  // 3. IMAGE PRODUCTION & TECHNICAL PARAMETERS
  {
    id: 16,
    part: 'Part IV',
  ...
  // 4. ADVANCED MODALITIES & DIGITAL IMAGING
  {
    id: 25,
    part: 'Part V',
  ...
  // 5. RADIOGRAPHIC POSITIONING & ANATOMY
  {
    id: 8,
    part: 'Part II',
  ...
  // 7. NON-TECHNICAL & GRAND MOCK EXAM
  {
    id: 29,
    part: 'Part V',
